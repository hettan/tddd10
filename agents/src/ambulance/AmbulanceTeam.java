...
public class AmbulanceTeam extends AbstractSampleAgent<AmbulanceTeam> {
	private Collection<EntityID> unexploredBuildings;
	private Collection<EntityID> ListBuriedCivilians;
	...
	protected void think(int time, ChangeSet changed, Collection<Command> heard) {
		...
		boolean task = updateListBuriedCivilians();
		if (task==false) updateUnexploredBuildings(changed);
	...
	private boolean updateListBuriedCivilians() {
		// TODO Auto-generated method stub
		for (EntityID next : changed.getChangedEntities()) {
			ListBuriedCivilians.remove(next);
		}
		if(ListBuriedCivilians== null) return false;
		else return true;
	}
